...
.task-item {
    ...
    /* box-shadow: 0 4px 8px #868279; */
    transition: transform 0.2s;
}
.task-item:hover {
    transform: translateY(-8px);
    box-shadow: 0 6px 12px #868279;
}
.task-item h2 {
    font-size: 1.5em;
    margin: 0 0 10px;
...
.task-item .button {
    ...
    margin-top: 15px;
    padding: 12px 18px;
    background-color: var(--button-bg, #434938);
    color: white;
    border-radius: 5px;
...
.task-item .button.delete {
    background-color: #954a37;
}
.task-item .button.delete:hover {
    background-color: #603522;
}
.task-item .button:hover {
    background-color: var(--button-hover, #434938);
}
</style>
